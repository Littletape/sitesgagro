                   ...
                   <!--  <div class="row">
                         <div class="col-md-12">
                              ...
                              <select id="selEdicao" class="form-control">
                                   <option>Edição Completa - 2017</option>
                              </select>
                         </div>
                    </div><br> -->
          <!--Select edição-->
          <center><h4 id=nEdicao>Edição de 2017 </h4></center>
          ...
          $(document).ready(function(){ 
               $(document).on("click","#buscar",function(){
                    function buscaTrabAnais(){     
                         ...
                         $.ajax({
                           type: "POST",
                           url: "../controller/buscaTrabalhosAtual.php",
                           data: env,
                           dataType : 'json',
                      ...
                      success: function(data){
                         ...
                         $.each(data,function(key,val){
                              ...
                              if(data[key]['autor_5'] == null){
                         		...
                         		var resumo = data[key]['resumo'];
                              var linha =      '<div>';
                                   linha +=       '<div class="panel panel-success">';
                                        linha +=       '<div id="tituloTrab" class="panel-heading" style="font-size:18px">'+data[key]['titulo']+'</div>';
                                             linha +=       '<div class="panel-body">';
                                                  
                                                       linha +=       '<div id="dadosTrab" class="row" style="font-size:16px;margin-left:10px"><b>Autores:</b> '+data[key]['autor_1']+', '+data[key]['autor_2']+ ', '+data[key]['autor_3']+', '+data[key]['autor_4']+', ' +data[key]['autor_5']+'  <br> <b>Categoria:</b> '+data[key]['categoria'] +' <br> <b>Subárea:</b> '+data[key]['area'] +' <br> <b>Instituição:</b> '+data[key]['instituicao'] +'<br><br><b>Resumo:</b>'+resumo+'<br> <button class="btn btn-success visuTrab" type="button" id="'+data[key]['idartigo']+'">Visualizar trabalho </button></div>';
                                                  linha +=    '</div>';
                                                  linha+=        '</div>';
                                             linha+=   '</div>';                                    
...
<script type="text/javascript">
     $(document).on("click",".visuTrab",function(){
          ...
          window.open("visualizartrabalhoAtual.php?id="+id);
     });
</script>
